		...
		<ul>
			...
			<li class="verticalTwoBox verticalTwoBox-imageLeft wow fadeInUp">
				...
				<div class="verticalTwoBox_content">
					...
					専門用語はなるべく使わず、親身になって寄り添う姿勢を心がけておりますので、生粋のIT企業はもちろん、これからの事業のWeb戦略について「何をどうしたら良いか分からない」「課題感はあるけれど解決の糸口が見つからない」といった場合に効果的なお力添えを致します。<br /><br />
					最先端の技術知見と経営的観点の両方を持って、「技術的には正しいが経営的には正しくない選択」、あるいはその逆といった難しい場面でも、現実に即した理想的ソリューションをご提案していきます。<br /><br />
